package mc.arch.minigames.versioned.modern.custom;
...
public class SpigotStoreMongoLoader extends UpdatableLoader {

    private static final Logger LOGGER = LoggerFactory.getLogger(SpigotStoreMongoLoader.class);

    private final MongoClient client;
    private final String database;
    private final String collection;

    public SpigotStoreMongoLoader(String database, String collection) {
        this.database = database;
        this.collection = collection;
        this.client = ScalaDataStoreSpigotImpl.getINSTANCE()
                .getNewMongoConnection().createNewConnection();
