...
import gg.tropic.practice.map.metadata.impl.MapTeamUpgraderMetadata
 ...
 * @since 11/10/2022
 */
object MapTeamUpgraderMetadataScanner : AbstractMapMetadataScanner<MapTeamUpgraderMetadata>()
{
    override val type = "upgrades"

    override fun isAllExtra() = true
    override fun scan(
        id: String, models: List<MapSignMetadataModel>, world: World
    ): MapTeamUpgraderMetadata
    {
        val model = models
            .groupBy {
        ...
        return MapTeamUpgraderMetadata(id, model)
    }
}
