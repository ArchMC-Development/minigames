package gg.tropic.practice.schematics.manipulation;
...
public class BlockChanger {
    ...
    private static final boolean IS_LEGACY = ServerVersion.getVersion().isOlderThan(ServerVersion.v1_9);
    ...
    public static void invalidate(World world) {
        worldCache.remove(world.getUID().getMostSignificantBits());
    }
